...
namespace AkilliMum.SRP.PostProcessing
{
    public class SimplePostProcess : ScriptableRendererFeature
    {
        class CustomRenderPass : ScriptableRenderPass
        {
            ...
            private Material _pixelisationMat;
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                using (new ProfilingScope(cmd, new ProfilingSampler(Tag)))
                {
                    ...
                    else if (_volume is VCRVolume vcrVolume && _volume != null)
                    {
                        ...
                        _activeMat = _vcrMat;
                    }else if (_volume is PixelisationVolume pixelisationVolume && _volume != null)
                    {
                        if (_pixelisationMat == null)
                            _pixelisationMat = new Material(Shader.Find("AkilliMum/SRP/PostProcessing/Pixelisation"));
                        _pixelisationMat.SetFloat("_Val", pixelisationVolume.Pixelisation.value);
                        _activeMat = _pixelisationMat;
        ...
        private CustomRenderPass _pixelisationPass;
        ...
        private PixelisationVolume _pixelisationVolume;
        ...
        public override void Create()
        {
            ...
            _pixelisationVolume = VolumeManager.instance.stack.GetComponent<PixelisationVolume>();
            ...
            _pixelisationPass = new CustomRenderPass(_pixelisationVolume);
            ...
            _pixelisationPass.renderPassEvent = _pixelisationVolume?.When?.value ?? RenderPassEvent.AfterRenderingTransparents;
